...
@Component({
  selector: 'app-modern-template-green',
  templateUrl: './modern-template-green.component.html',
  styleUrls: ['./modern-template-green.component.css']
})
export class ModernTemplateGreenComponent implements OnInit {
